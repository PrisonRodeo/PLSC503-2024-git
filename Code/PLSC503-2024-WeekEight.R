...
# 
# temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/Justices.csv")
...
ANES<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/main/Data/ANES2020.csv")
...
pdf("ANES-MICE-Figure.pdf",7,5)
par(mar=c(4,4,2,2))
dotchart(comp,pch=19,xlab="Coefficient Estimate")
abline(v=0,lwd=1,lty=2,col="grey")
points(mcar,1:7,pch=17,col="blue")
points(mnar,1:7,pch=4,col="orange")
legend("topright",bty="n",pch=c(19,17,4),
