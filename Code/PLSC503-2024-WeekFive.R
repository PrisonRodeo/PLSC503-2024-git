...
# Intro things                                ####
#
# PLSC 503 -- Spring 2024: Code for Week Five
#
# "Variance things"
#=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
#
...
Africa<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/africa2001.csv")
...
impeachment<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/impeachment.csv")
