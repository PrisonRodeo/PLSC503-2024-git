...
# Introduction                                      ####
#
# PLSC 503 -- Spring 2024: Code for Week Six
...
flintstones<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/flintstones.csv")
...
NewDahl<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/NewDahl.csv")
...
IRData<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/IRData.csv")
